...
import doctorImagem from "../../../../public/doctor-hero.png"
      ...
      <div className="container mx-auto px-4 pt-20 pb-4 sm:pb-0 sm:px-6 lg:px-8">
        <main className="flex items-center justify-center">
          ...
          <article className="max-w-3xl flex-[2] space-y-8 flex flex-col justify-center">
            ...
            <Button className="bg-emerald-500 hover:bg-emerald-600 cursor-pointer w-fit px-6 font-semibold">Encontre uma clínica</Button>
          </article>
